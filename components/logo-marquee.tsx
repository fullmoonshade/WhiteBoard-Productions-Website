...
export function LogoMarquee() {
  ...
  const logos = [
    ...
    { name: "Skitbit", content: "image", color: "text-neutral-300", image: "/icons/skitbit-white.svg" },
    ...
    { name: "ESJ", content: "image", color: "text-neutral-300", image: "/placeholder-logo.svg" },
