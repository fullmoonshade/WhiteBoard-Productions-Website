      ...
      <div className="container mx-auto px-4 py-16 sm:py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-2 max-w-xl text-sm text-neutral-400" itemProp="description">
            No hidden fees. Just world-class podcasting and video editing that fits your budget.
          </p>
          <div className="mt-6">
            <Button
              asChild
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-3">
          ...
          >
            ...
            <CardContent className="pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "10–15s Video Clips",
                  "Professional audio cleanup & enhancement",
                  "2 revisions included",
                  "Delivered in 5 business days",
                  "Social media ready formats (IG, TikTok, YouTube)",
                  "Podcast editing & production included",
                ].map((f, i) => (
          ...
          >
            ...
            <CardContent className="pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "20–25s Video Content",
                  "Broadcast-quality audio mastering",
                  "4 structured revisions included",
                  "Delivered in 1 week",
                  "Multi-platform optimization & formatting",
                  "Full podcast production & editing",
                ].map((f, i) => (
                  <FeatureItem key={i} text={f} />
                ))}
              </ul>
          ...
          >
            ...
            <CardContent className="relative pt-0">
              <ul className="grid gap-2" itemProp="description">
                {[
                  "30–40s Premium Video Content",
                  "Studio-quality audio & video production",
                  "Delivered in 2 weeks",
                  "Advanced color grading & visual effects",
